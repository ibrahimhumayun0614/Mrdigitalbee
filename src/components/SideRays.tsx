...
void main() {
  ...
  if (iBottomCenter > 0.5) {
    rayPos = vec2(iResolution.x * 0.5, iResolution.y * 1.12);
    baseAngle = -1.570796;
  } else {
  ...
  gl_FragColor = color;
      ...
      const isBottomCenter = origin === "bottom-center" ? 1 : 0;
      const uniforms = {
        iTime: { value: 0 },
        ...
        iBottomCenter: { value: isBottomCenter },
      };
  ...
  useEffect(() => {
    ...
    u.iBottomCenter.value = origin === "bottom-center" ? 1 : 0;
  }, [
    speed,
    rayColor1,
    rayColor2,
